...
A basic Minecraft-like chunk system.

**Contributions and suggestions for code improvements are welcome!**


## Features

- Support for multiple worlds
- Creation and loading of regions, chunks, and blocks
- Chunk compression
- Custom block implementation
- Multithreaded saving and loading with symmetrical read and write speeds (350 chunks per second)
